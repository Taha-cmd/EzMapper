...
namespace EzMapper.Tests
{
    public class PrimaryKeyTests
    {
        ...
        public void Model_Has_More_Than_One_PrimaryKey()
        {
            ...
            Assert.Throws<Exception>(() => SqlTypeInspector.GetPrimaryKeyPropertyName(model.GetType().GetProperties()));
        }
        ...
        public void Model_Has_PrimaryKey_Attribute()
        {
            ...
            var returned = SqlTypeInspector.GetPrimaryKeyPropertyName(model.GetType().GetProperties());
